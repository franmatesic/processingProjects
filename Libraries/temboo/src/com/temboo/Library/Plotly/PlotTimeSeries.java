...
*/
public class PlotTimeSeries extends Choreography {

	/**
	Create a new instance of the PlotTimeSeries Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public PlotTimeSeries(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Plotly/PlotTimeSeries"));
	}
	...
	*/
	...
	@param String - (required, json) A JSON array of timestamps representing the "x" coordinates to be plotted on the graph. Timestamps should be formatted as YYYY-MM-DD HH:MM:SS.
	*/
	...
	@param String - (required, json) A  JSON array of values representing the "y" coordinates associated with the specified timestamps.
	*/
	 ...
	 */
	@Override
	public PlotTimeSeriesResultSet run() {
		JSONObject result = super.runWithResults();
		return new PlotTimeSeriesResultSet(result);
	}
