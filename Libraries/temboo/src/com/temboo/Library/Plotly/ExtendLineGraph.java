...
*/
public class ExtendLineGraph extends Choreography {

	/**
	Create a new instance of the ExtendLineGraph Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ExtendLineGraph(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Plotly/ExtendLineGraph"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ExtendLineGraphResultSet run() {
		JSONObject result = super.runWithResults();
		return new ExtendLineGraphResultSet(result);
	}
