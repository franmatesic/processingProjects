...
public class GetLastMessageThatContains extends Choreography {
	...
	*/
	...
	/** 
	Set the value of the AfterSID input for this Choreo. 

	@param String - (optional, string) Returns messages after the specified message sid. Required when using the pagination parameters. To return message sids in the response, set ResponseMode to "verbose".
	*/
	public void setAfterSID(String value) {
		this.inputs.setInput("AfterSID", value);
	}
