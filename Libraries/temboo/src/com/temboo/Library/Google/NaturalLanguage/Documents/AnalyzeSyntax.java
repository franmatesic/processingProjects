...
public class AnalyzeSyntax extends Choreography {
	...
	*/
	public AnalyzeSyntax(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/NaturalLanguage/Documents/AnalyzeSyntax"));
	}
	...
	*/
	 ...
	 */
	@Override
	public AnalyzeSyntaxResultSet run() {
		JSONObject result = super.runWithResults();
		return new AnalyzeSyntaxResultSet(result);
	}
