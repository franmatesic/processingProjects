...
*/
public class AnalyzeSentiment extends Choreography {

	/**
	Create a new instance of the AnalyzeSentiment Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public AnalyzeSentiment(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/NaturalLanguage/Documents/AnalyzeSentiment"));
	}
	...
	*/
	 ...
	 */
	@Override
	public AnalyzeSentimentResultSet run() {
		JSONObject result = super.runWithResults();
		return new AnalyzeSentimentResultSet(result);
	}
