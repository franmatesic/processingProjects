...
*/
public class BatchUpdateValues extends Choreography {

	/**
	Create a new instance of the BatchUpdateValues Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public BatchUpdateValues(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Sheets/BatchUpdateValues"));
	}
	...
	*/
	...
	@param String - (required, json) An array of JSON objects containing the ranges and values to update. See Choreo notes below for more details.
	*/
	...
	*/
	 ...
	 */
	@Override
	public BatchUpdateValuesResultSet run() {
		JSONObject result = super.runWithResults();
		return new BatchUpdateValuesResultSet(result);
	}
