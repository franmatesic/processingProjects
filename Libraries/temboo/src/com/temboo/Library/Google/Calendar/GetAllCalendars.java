...
public class GetAllCalendars extends Choreography {
	...
	*/
	...
	@param Integer - (optional, integer) The maximum number of results to return on one result page.
	*/
	...
	@param String - (optional, integer) The maximum number of results to return on one result page.
	*/
