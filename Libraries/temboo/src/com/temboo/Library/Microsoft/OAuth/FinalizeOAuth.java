...
public class FinalizeOAuth extends Choreography {
	...
	*/
	public FinalizeOAuth(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Microsoft/OAuth/FinalizeOAuth"));
	}
	...
	*/
	...
	@param String - (conditional, string) The App ID URI of the web API (secured resource). See Choreo notes for details. This can be left blank when using the Excel API.
	*/
