...
public class InitializeOAuth extends Choreography {
	...
	*/
	...
	@param String - (conditional, string) The App ID URI of the web API (secured resource). See Choreo notes for details. Used for PowerBI only.
	*/
	...
	@param String - (conditional, string) A space-delimited list of the permissions that the user must accept e.g. Files.ReadWrite. Used for Excel only.
	*/
