...
*/
public class GetLastCell extends Choreography {

	/**
	Create a new instance of the GetLastCell Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetLastCell(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Microsoft/Excel/Range/GetLastCell"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetLastCellResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetLastCellResultSet(result);
	}
