...
*/
public  class DeleteRangeResultSet extends ResultSet {
		
	public DeleteRangeResultSet(JSONObject doc) {
		super(doc);
	}
	...
	@return String - (integer) The response status code. A 204 is returned for a successful deletion.
	*/
