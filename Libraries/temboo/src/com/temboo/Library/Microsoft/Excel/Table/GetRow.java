...
*/
public class GetRow extends Choreography {

	/**
	Create a new instance of the GetRow Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetRow(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Microsoft/Excel/Table/GetRow"));
	}
	...
	*/
	...
	@param Integer - (required, integer) The index of the row that should be returned. If left empty, the last row in the table will be returned.
	*/
	...
	@param String - (required, integer) The index of the row that should be returned. If left empty, the last row in the table will be returned.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetRowResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetRowResultSet(result);
	}
