...
*/
public class DataBodyRange extends Choreography {

	/**
	Create a new instance of the DataBodyRange Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DataBodyRange(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Microsoft/Excel/Table/DataBodyRange"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DataBodyRangeResultSet run() {
		JSONObject result = super.runWithResults();
		return new DataBodyRangeResultSet(result);
	}
