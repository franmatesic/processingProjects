...
*/
public class GetLastColumn extends Choreography {

	/**
	Create a new instance of the GetLastColumn Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetLastColumn(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Microsoft/Excel/Range/GetLastColumn"));
	}
	...
	*/
	...
	@param String - (conditional, string) The cell range to consider (e.g. A1:C100).
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetLastColumnResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetLastColumnResultSet(result);
	}
