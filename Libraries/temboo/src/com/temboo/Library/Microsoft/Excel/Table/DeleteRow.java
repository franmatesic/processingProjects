...
public class DeleteRow extends Choreography {
	...
	*/
	public DeleteRow(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Microsoft/Excel/Table/DeleteRow"));
	}
	...
	*/
	...
	@param Integer - (required, integer) The index of the row that should be deleted.
	*/
	...
	@param String - (required, integer) The index of the row that should be deleted.
	*/
