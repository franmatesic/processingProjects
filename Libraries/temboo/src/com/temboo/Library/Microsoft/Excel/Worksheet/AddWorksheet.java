...
public class AddWorksheet extends Choreography {
	...
	*/
	public AddWorksheet(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Microsoft/Excel/Worksheet/AddWorksheet"));
	}
	...
	*/
	...
	@param String - (required, string) The name of the new worksheet.
	*/
