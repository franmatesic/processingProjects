...
*/
public class FindPlacesByName extends Choreography {

	/**
	Create a new instance of the FindPlacesByName Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public FindPlacesByName(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Factual/FindPlacesByName"));
	}
	...
	*/
	 ...
	 */
	@Override
	public FindPlacesByNameResultSet run() {
		JSONObject result = super.runWithResults();
		return new FindPlacesByNameResultSet(result);
	}
