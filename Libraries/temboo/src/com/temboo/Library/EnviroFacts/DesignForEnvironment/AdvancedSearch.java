...
public class AdvancedSearch extends Choreography {
	...
	*/
	...
	@param String - (conditional, string) Indicate the product, code, or sector to search for. Used together with SearchType and the optional Operator input to create a customized search.
	*/
