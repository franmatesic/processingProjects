...
*/
public class DeleteMLModel extends Choreography {

	/**
	Create a new instance of the DeleteMLModel Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteMLModel(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/MachineLearning/DeleteMLModel"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteMLModelResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteMLModelResultSet(result);
	}
