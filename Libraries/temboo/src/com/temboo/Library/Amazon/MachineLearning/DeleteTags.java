...
public class DeleteTags extends Choreography {
	...
	*/
	public DeleteTags(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/MachineLearning/DeleteTags"));
	}
	...
	*/
	...
	@param String - (required, json) One or more tags to delete.
	*/
	public void setTagKeys(String value) {
		this.inputs.setInput("TagKeys", value);
	}
