...
*/
public class GetEvaluation extends Choreography {

	/**
	Create a new instance of the GetEvaluation Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetEvaluation(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/MachineLearning/GetEvaluation"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the Evaluation to retrieve.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetEvaluationResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetEvaluationResultSet(result);
	}
