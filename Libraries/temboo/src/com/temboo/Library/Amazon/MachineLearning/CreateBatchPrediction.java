...
public class CreateBatchPrediction extends Choreography {
	...
	*/
	public CreateBatchPrediction(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/MachineLearning/CreateBatchPrediction"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the DataSource that points to the group of observations to predict.
	*/
	public void setBatchPredictionDataSourceId(String value) {
		this.inputs.setInput("BatchPredictionDataSourceId", value);
	}
	...
	@param String - (required, string) A user-supplied ID that uniquely identifies the BatchPrediction.
	*/
	...
	@param String - (optional, string) A user-supplied name or description of the BatchPrediction.
	*/
	...
	@param String - (required, string) The ID of the MLModel that will generate predictions for the group of observations.
	*/
	...
	@param String - (required, string) The location of an Amazon S3 bucket or directory to store the batch prediction results.
	*/
	public void setOutputUri(String value) {
		this.inputs.setInput("OutputUri", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateBatchPredictionResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateBatchPredictionResultSet(result);
	}
