...
*/
public class CreateEvaluation extends Choreography {

	/**
	Create a new instance of the CreateEvaluation Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateEvaluation(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/MachineLearning/CreateEvaluation"));
	}
	...
	*/
	public void setEvaluationDataSourceId(String value) {
		this.inputs.setInput("EvaluationDataSourceId", value);
	}
	...
	*/
	...
	@param String - (required, string) The ID of the MLModel to evaluate.
	*/
	...
	*/
	 ...
	 */
	@Override
	public CreateEvaluationResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateEvaluationResultSet(result);
	}
