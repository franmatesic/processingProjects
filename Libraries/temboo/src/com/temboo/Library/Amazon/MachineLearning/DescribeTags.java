...
public class DescribeTags extends Choreography {
	...
	*/
	public DescribeTags(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/MachineLearning/DescribeTags"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the ML object.
	*/
	...
	@param String - (required, string) The type of the ML object. Valid values are: BatchPrediction, DataSource, Evaluation, MLModel.
	*/
