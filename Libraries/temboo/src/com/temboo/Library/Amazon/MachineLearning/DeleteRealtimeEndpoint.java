...
*/
public class DeleteRealtimeEndpoint extends Choreography {

	/**
	Create a new instance of the DeleteRealtimeEndpoint Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteRealtimeEndpoint(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/MachineLearning/DeleteRealtimeEndpoint"));
	}
	...
	*/
	...
	@param Boolean - (optional, boolean) Specifies whether the GetMLModel operation should return Recipe. Defaults to false.
	*/
	...
	@param String - (optional, boolean) Specifies whether the GetMLModel operation should return Recipe. Defaults to false.
	*/
	 ...
	 */
	@Override
	public DeleteRealtimeEndpointResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteRealtimeEndpointResultSet(result);
	}
