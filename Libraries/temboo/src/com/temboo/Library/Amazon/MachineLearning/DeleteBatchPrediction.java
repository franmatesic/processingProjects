...
*/
public class DeleteBatchPrediction extends Choreography {

	/**
	Create a new instance of the DeleteBatchPrediction Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteBatchPrediction(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/MachineLearning/DeleteBatchPrediction"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteBatchPredictionResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteBatchPredictionResultSet(result);
	}
