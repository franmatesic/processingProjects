...
*/
public class Predict extends Choreography {

	/**
	Create a new instance of the Predict Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Predict(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/MachineLearning/Predict"));
	}
	...
	*/
	...
	@param String - (required, string) A unique identifier of the MLModel.
	*/
	...
	@param String - (required, string) The realtime endpoint to use for the prediction.
	*/
	public void setPredictEndpoint(String value) {
		this.inputs.setInput("PredictEndpoint", value);
	}
	...
	@param String - (required, json) A map of variable name-value pairs that represent an observation.
	*/
	...
	*/
	 ...
	 */
	@Override
	public PredictResultSet run() {
		JSONObject result = super.runWithResults();
		return new PredictResultSet(result);
	}
