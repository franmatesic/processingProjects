...
*/
public class UpdateDataSource extends Choreography {

	/**
	Create a new instance of the UpdateDataSource Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateDataSource(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/MachineLearning/UpdateDataSource"));
	}
	...
	*/
	...
	@param String - (required, string) The ID assigned to the DataSource at creation.
	*/
	...
	@param String - (required, string) A new user-supplied name or description of the DataSource that will replace the current description.
	*/
	...
	*/
	 ...
	 */
	@Override
	public UpdateDataSourceResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateDataSourceResultSet(result);
	}
