...
*/
public class GetDataSource extends Choreography {

	/**
	Create a new instance of the GetDataSource Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetDataSource(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/MachineLearning/GetDataSource"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetDataSourceResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetDataSourceResultSet(result);
	}
