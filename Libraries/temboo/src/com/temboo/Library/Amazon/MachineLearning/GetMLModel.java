...
*/
public class GetMLModel extends Choreography {

	/**
	Create a new instance of the GetMLModel Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetMLModel(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/MachineLearning/GetMLModel"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetMLModelResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetMLModelResultSet(result);
	}
