package com.temboo.Library.Amazon.Lex.RuntimeService;
...
*/
public class PostText extends Choreography {

	/**
	Create a new instance of the PostText Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public PostText(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/Lex/RuntimeService/PostText"));
	}
	...
	*/
	public void setInputString(String value) {
		this.inputs.setInput("InputString", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public PostTextResultSet run() {
		JSONObject result = super.runWithResults();
		return new PostTextResultSet(result);
	}
