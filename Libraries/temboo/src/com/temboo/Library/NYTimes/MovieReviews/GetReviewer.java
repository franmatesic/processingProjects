...
public class GetReviewer extends Choreography {
	...
	*/
	...
	@param String - (optional, string) Specify "all", "full-time", or "part-time" for that subset. Specify a reviewer's name to get details about a reviewer (e.g. Manohla Dargis).
	*/
