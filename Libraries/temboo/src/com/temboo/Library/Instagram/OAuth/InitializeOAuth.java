...
public class InitializeOAuth extends Choreography {
	...
	*/
	public InitializeOAuth(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Instagram/OAuth/InitializeOAuth"));
	}
	...
	*/
	...
	@param String - (conditional, string) The scope of the access you're requesting from the user. Valid values are: basic, public_content, follower_list, comments, relationships, and likes. Multiple scope values should separated by spaces.
	*/
